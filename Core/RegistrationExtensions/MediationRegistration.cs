...
public static class MediationRegistration
{
    public static IServiceCollection InjectCommands(this IServiceCollection services) => services
        ...
        .AddTransient<CommandHandler<AddUserUploadCommand>, AddUserUploadCommandHandler>()
        .AddTransient<CommandHandler<UploadFileCommand>, UploadFileCommandHandler>()
        ;
    ...
    public static IServiceCollection InjectQueries(this IServiceCollection services) => services
        ...
        .AddTransient<QueryHandler<GetDownloadDirectoryConfigurationsQuery, IEnumerable<DirectoryConfiguration>>, GetDownloadDirectoryConfigurationsQueryHandler>()
        .AddTransient<QueryHandler<GetUploadDirectoryConfigurationsQuery, IEnumerable<DirectoryConfiguration>>, GetUploadDirectoryConfigurationsQueryHandler>()
    ...
    public static IServiceCollection InjectMediator(this IServiceCollection services)
    {
        _ = services.AddTransient<IMediator>((provider) =>
        {
            ...
            _ = mediator
                ...
                .Register(provider.GetRequiredService<CommandHandler<AddUserUploadCommand>>())
                .Register(provider.GetRequiredService<CommandHandler<UploadFileCommand>>())
                ;
            ...
            _ = mediator
                ...
                .Register(provider.GetRequiredService<QueryHandler<GetDownloadDirectoryConfigurationsQuery, IEnumerable<DirectoryConfiguration>>>())
                .Register(provider.GetRequiredService<QueryHandler<GetUploadDirectoryConfigurationsQuery, IEnumerable<DirectoryConfiguration>>>())
